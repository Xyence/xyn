...
def _ensure_remote_workspace_via_container(*, api_container_name: str, workspace_slug: str, workspace_title: str) -> Optional[Dict[str, Any]]:
    ...
    script = (
        ...
        "    _ensure_default_xyn_solution_for_workspace,\n"
...
{postgres_backend_env}\
      ...
      OIDC_ISSUER: ${{OIDC_ISSUER:-${{XYN_OIDC_ISSUER:-}}}}
      OIDC_CLIENT_ID: ${{OIDC_CLIENT_ID:-${{XYN_OIDC_CLIENT_ID:-}}}}
      OIDC_CLIENT_SECRET: ${{OIDC_CLIENT_SECRET:-${{XYN_OIDC_CLIENT_SECRET:-}}}}
      OIDC_REDIRECT_URI: ${{OIDC_REDIRECT_URI:-${{XYN_OIDC_REDIRECT_URI:-}}}}
      ...
      XYN_BOOTSTRAP_ADMIN_EMAILS: ${{XYN_BOOTSTRAP_ADMIN_EMAILS:-}}
      ...
      XYN_SOLUTION_BUNDLE_SOURCES: ${{XYN_SOLUTION_BUNDLE_SOURCES:-}}
      ...
      XYN_REMOTE_ARTIFACT_OWNERSHIP_OVERRIDES: '${{XYN_REMOTE_ARTIFACT_OWNERSHIP_OVERRIDES:-}}'
